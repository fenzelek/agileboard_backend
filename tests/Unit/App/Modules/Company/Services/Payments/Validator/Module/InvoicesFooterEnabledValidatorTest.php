...
use App\Modules\Company\Services\Payments\Validator\Module\InvoicesFooterEnabledValidator;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Tests\TestCase;
use Tests\Unit\App\Modules\Company\Services\Payments\Validator\Module\Traits\PackageModuleValidateTrait;

class InvoicesFooterEnabledValidatorTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->validator = new InvoicesFooterEnabledValidator();
    }

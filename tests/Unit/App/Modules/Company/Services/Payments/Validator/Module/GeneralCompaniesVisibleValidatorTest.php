...
use App\Modules\Company\Services\Payments\Validator\Module\GeneralCompaniesVisibleValidator;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Tests\TestCase;

class GeneralCompaniesVisibleValidatorTest extends TestCase
{
    ...
    public function validate_success()
    {
        ...
        $validator = new GeneralCompaniesVisibleValidator();

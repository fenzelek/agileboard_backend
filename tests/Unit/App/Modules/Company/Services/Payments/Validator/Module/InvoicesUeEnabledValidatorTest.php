...
use App\Modules\Company\Services\Payments\Validator\Module\InvoicesUeEnabledValidator;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Tests\TestCase;

class InvoicesUeEnabledValidatorTest extends TestCase
{
    ...
    public function validate_success()
    {
        ...
        $validator = new InvoicesUeEnabledValidator();

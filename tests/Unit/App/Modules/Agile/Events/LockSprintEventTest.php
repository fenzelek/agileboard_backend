...
class LockSprintEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new LockSprintEvent($this->project, $this->sprint);
    }
    ...
    {
        $this->assertSame(EventTypes::SPRINT_LOCK, $this->event->getType());
    }
    ...
    public function getBroadcastData()
    {
        ...
        $this->assertSame(true, $data['locked']);
    }
}

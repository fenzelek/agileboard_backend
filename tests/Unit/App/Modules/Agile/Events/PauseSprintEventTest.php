...
class PauseSprintEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new PauseSprintEvent($this->project, $this->sprint);
    }
    ...
    {
        $this->assertSame(EventTypes::SPRINT_PAUSE, $this->event->getType());
    }
    ...
    public function getBroadcastData()
    {
        ...
        $this->assertSame(Sprint::PAUSED, $data['status']);
    }
}

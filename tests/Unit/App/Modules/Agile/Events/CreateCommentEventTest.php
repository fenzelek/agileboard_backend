...
class CreateCommentEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->comment = factory(TicketComment::class)->make(['id' => 1, 'ticket_id' => $this->ticket->id, 'user_id' => $this->author->id, 'text' => 'test']);
        $this->event = new CreateCommentEvent($this->project, $this->ticket, $this->comment);
    }
    ...
    public function getMessage()
    {
        ...
        $this->assertSame($this->comment->user->first_name . ' ' . $this->comment->user->last_name . ' dodał komentarz: ' . $this->comment->text, $data['content']);
    }
    ...
    {
        $this->assertSame(EventTypes::TICKET_COMMENT_STORE, $this->event->getType());
    }

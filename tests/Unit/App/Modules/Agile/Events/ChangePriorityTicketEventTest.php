...
class ChangePriorityTicketEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new ChangePriorityTicketEvent($this->project, $this->ticket, 1, 2);
    }
    ...
    {
        $this->assertSame(EventTypes::TICKET_CHANGE_PRIORITY, $this->event->getType());
    }
    ...
    {
        $this->assertSame(BroadcastChannels::TICKET_CHANGE_PRIORITY, $this->event->getBroadcastChannel());
    }

...
class SetFlagToShowTicketEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new SetFlagToShowTicketEvent($this->project, $this->ticket, 0);
    }
    ...
    {
        $this->assertSame(EventTypes::TICKET_SET_SHOW_FLAG, $this->event->getType());
    }

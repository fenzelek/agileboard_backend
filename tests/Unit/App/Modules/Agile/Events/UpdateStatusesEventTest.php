...
class UpdateStatusesEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new UpdateStatusesEvent($this->project);
    }
    ...
    {
        $this->assertSame(EventTypes::STATUSES_UPDATE, $this->event->getType());
    }

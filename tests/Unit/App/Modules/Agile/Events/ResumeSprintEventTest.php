...
class ResumeSprintEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new ResumeSprintEvent($this->project, $this->sprint);
    }
    ...
    {
        $this->assertSame(EventTypes::SPRINT_RESUME, $this->event->getType());
    }

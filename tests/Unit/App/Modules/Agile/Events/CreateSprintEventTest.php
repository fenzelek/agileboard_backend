...
class CreateSprintEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new CreateSprintEvent($this->project, $this->sprint);
    }
    ...
    {
        $this->assertSame(EventTypes::SPRINT_STORE, $this->event->getType());
    }
    ...
    {
        $this->assertSame(BroadcastChannels::SPRINT_STORE, $this->event->getBroadcastChannel());
    }

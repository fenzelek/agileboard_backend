...
class UnlockSprintEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new UnlockSprintEvent($this->project, $this->sprint);
    }
    ...
    {
        $this->assertSame(EventTypes::SPRINT_UNLOCK, $this->event->getType());
    }
    ...
    {
        $this->assertSame(BroadcastChannels::SPRINT_LOCK, $this->event->getBroadcastChannel());
    }
    ...
    public function getBroadcastData()
    {
        ...
        $this->assertSame(false, $data['locked']);
    }
}

...
class DeleteSprintEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new DeleteSprintEvent($this->project, $this->sprint);
    }
    ...
    {
        $this->assertSame(EventTypes::SPRINT_DELETE, $this->event->getType());
    }
    ...
    {
        $this->assertSame(BroadcastChannels::SPRINT_DELETE, $this->event->getBroadcastChannel());
    }

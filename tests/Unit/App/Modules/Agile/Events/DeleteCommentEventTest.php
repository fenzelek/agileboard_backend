...
class DeleteCommentEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new DeleteCommentEvent($this->project, $this->ticket, $this->comment);
    }
    ...
    {
        $this->assertSame(EventTypes::TICKET_COMMENT_DELETE, $this->event->getType());
    }

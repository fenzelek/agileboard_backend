...
class TodayScheduledDateEventTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->event = new TodayScheduledDateEvent($this->project, $this->ticket);
    }
    ...
    public function getMessage()
    {
        ...
        $this->assertSame(
            'Zadanie [' . $this->ticket->title . '] "' . $this->ticket->name . '" dziś ma zaplanowany dzień zakończenia prac.',
            $data['content']
        );
    }
    ...
    {
        $this->assertSame(EventTypes::TICKET_TODAY_SCHEDULED_DATE, $this->event->getType());
    }

...
class IsTourOperatorMarginTest extends TestCase
{
    /** @test */
    public function it_returns_true_for_margin_tour_operator()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',
        ...
        $this->assertTrue($margin_procedure->isTourOperatorMargin($invoice));
    }

    /** @test */
    public function it_returns_false_for_margin_used_product()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',
        ...
        $this->assertFalse($margin_procedure->isTourOperatorMargin($invoice));
    }

    /** @test */
    public function it_returns_false_for_margin_art()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',
    ...
    /** @test */
    public function it_returns_false_for_margin_antique()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',
    ...
    /** @test */
    public function it_returns_true_for_margin_correction_tour_operator()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',
            new InvoiceTypeModel(['slug' => InvoiceTypeStatus::MARGIN_CORRECTION])
        );
        $invoice->setRelation(
            'invoiceMarginProcedure',
            new InvoiceMarginProcedure(['slug' => InvoiceMarginProcedureType::TOUR_OPERATOR])
    ...
    /** @test */
    public function it_returns_false_for_margin_correction_used_product()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',
    ...
    /** @test */
    public function it_returns_false_for_margin_correction_art()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',
    ...
    /** @test */
    public function it_returns_false_for_margin_correction_antique()
    {
        $invoice = new Invoice();
        $invoice->setRelation(
            'invoiceType',

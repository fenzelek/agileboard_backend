...
class GetRealRawNetPriceSumTest extends TestCase
{
    /** @test */
    public function it_returns_net_price_if_it_is_set()
    {
        ...
        $item = new ModelInvoiceItem(['price_net_sum' => $price_net]);

        $invoice_item = new InvoiceItem();
        $invoice_item->item = $item;

        $this->assertSame($price_net, $invoice_item->getRealRawNetPriceSum());
    }
    ...
    public function it_returns_valid_net_price_if_quantity_set_to_1()
    {
        ...
        $this->assertSame(81, $invoice_item->getRealRawNetPriceSum());
    }
    ...
    public function it_returns_valid_net_price_when_sum_cannot_be_divided_by_quantity()
    {
        ...
        $this->assertSame(4065, $invoice_item->getRealRawNetPriceSum());
    }
    ...
    public function it_returns_valid_net_price_when_correction_tax()
    {
        ...
        $this->assertSame(0, $invoice_item->getRealRawNetPriceSum());
    }
    ...
    public function it_returns_valid_differ_between_prices_when_correction_prices()
    {
        ...
        $this->assertSame(600, $invoice_item->getRealRawNetPriceSum());
    }
}

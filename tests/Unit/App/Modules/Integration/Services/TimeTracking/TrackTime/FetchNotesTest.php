...
class FetchNotesTest extends BrowserKitTestCase
{
    /**
     * @test
     ...
     */
    public function it_fetches_and_saves_notes()
    {
        ...
        $handler->shouldReceive('notes')->once()->withNoArgs()->andReturn($collection);

        $track_time->shouldReceive('saveNotes')->once()
        ...
        $notes_processor->shouldReceive('save')->once()

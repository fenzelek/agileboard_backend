...
class FetchActivitiesTest extends BrowserKitTestCase
{
    /**
     * @test
     ...
     */
    public function it_fetches_and_saves_activities()
    {
        ...
        $handler->shouldReceive('activities')->once()->withNoArgs()->andReturn($collection);

        $track_time->shouldReceive('saveActivities')->once()
        ...
        $activities_processor->shouldReceive('save')->once()

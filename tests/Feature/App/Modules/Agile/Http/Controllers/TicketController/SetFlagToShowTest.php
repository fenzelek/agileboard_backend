...
class SetFlagToShowTest extends BrowserKitTestCase
{
    ...
    /**
     * @scenario Tickets - set flag to show
     *      @suit Tickets - set flag to show
     *      @case Return error when user hasn't permission
     *
     * @covers \App\Modules\Agile\Http\Controllers\TicketController::history
     * @test
     */
    public function setFlagToShow_error_has_not_permission()
    {
     ...
     * @test
     */
    public function setFlagToShow_error_ticket_not_exist()
    {
     ...
     * @test
     */
    public function setFlagToShow_success_db()
    {
        ...
        $this->assertEquals(1, $history->value_before);
     ...
     * @test
     */
    public function setFlagToShow_success_response()
    {
        Event::fake();
        ...
        Event::assertDispatched(SetFlagToShowTicketEvent::class, function ($e) use ($ticket2) {
        ...
        $this->assertSame(false, $response_ticket['hidden']);
    ...
    {
        return "/projects/{$project_id}/tickets/{$ticket_id}/show?selected_company_id={$company_id}";
    }
}

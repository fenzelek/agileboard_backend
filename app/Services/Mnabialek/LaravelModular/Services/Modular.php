...
namespace App\Services\Mnabialek\LaravelModular\Services;
...
use App\Services\Mnabialek\LaravelModular\Traits\Normalizer;
...
class Modular
{
    ...
    public function loadRoutes(Registrar $router, $type = null)
    {
        $this->withRoutes($type)->each(function ($module) use ($router, $type) {
            /* @var Module $module */
            $router->group(
                ['namespace' => $module->routingControllerNamespace()],

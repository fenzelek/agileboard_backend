...
return [
    ...
    */
     ...
     */
    'notification' => [
        'driver' => env('NOTIFICATION_MAIL_DRIVER', env('MAIL_DRIVER', 'smtp')),
        ...
        'from' => [
            'address' => env('NOTIFICATION_EMAIL_FROM_ADDRESS', env('EMAIL_FROM_ADDRESS', null)),
            'name' => env('NOTIFICATION_EMAIL_FROM_NAME', env('EMAIL_FROM_NAME', null)),
        ],
    ],
];
